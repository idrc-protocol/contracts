...
contract IDRCv2 is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    address public hub;
    ...
    function initializeV2(address _hub, address _rewardDistributor) public reinitializer(2) {
        hub = _hub;
        rewardDistributor = IRewardDistributor(_rewardDistributor);
    }
